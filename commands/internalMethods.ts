...
export function get(func, param = null, expectJson = true) {
    ...
    if (ShouldInterfaceViaAsyncCallbacks('GET')) {
        callAsync('GET', url, null)
            .then((result: any) => {

                const resultJSON : AsyncCallbackResponse = JSON.parse(result)
...
export function post(func: string, data?) {
    ...
    if (ShouldInterfaceViaAsyncCallbacks('POST')) {
...
export function ddelete(func, data?) {
    ...
    if (ShouldInterfaceViaAsyncCallbacks('DELETE')) {
...
export function put(func, data = null) {
    ...
    if (ShouldInterfaceViaAsyncCallbacks('PUT')) {
