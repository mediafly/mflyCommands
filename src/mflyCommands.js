...
function putValue(key, value) {
    if (device_1.isWeb()) {
        ...
        return internalMethods_1.post("info/" + key, [{ key: key, value: value }]);
    }
}
